def show():
    ...
    print("volatility    [symbol]:              calculates the average daily change in a stock from a start and end date (stock_store must be run first)")

    # to be implemented
    print("aroc          [symbol]:                          finds the average rate of change of a stock given the data in its file (stock_store must be run first)")
